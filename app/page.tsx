...
import { ArrowRight, Gavel, Scale, ShieldCheck, Sparkles, Loader2, Play, FileText, UserRound } from "lucide-react";
...
const roleLabels: Record<string, string> = {
  ...
  plaintiff_attorney: "Representante do autor",
  defense_attorney: "Representante do réu",
  public_prosecutor: "Ministério Público",
  legal_researcher: "Pesquisador jurídico",
};
...
export default function Home() {
  ...
  const [characters, setCharacters] = useState<Array<{name:string;title:string;profession:string;role:string;fictional:boolean}>>([]);
